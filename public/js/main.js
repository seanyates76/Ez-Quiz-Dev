...
import { wireGenerator } from './generator.js?v=1.5.42';
import { dismissLandingIntro, wireLandingIntro } from './landing-intro.js?v=1.5.42';
import { setMode, beginQuiz, renderCurrentQuestion, updateNavButtons, updateProgress, wireQuizControls, wireResultsControls, pauseTimerIfQuiz, resumeTimerIfQuiz, syncSettingsFromUI, syncExplainButtonsVisibility } from './quiz.js?v=1.5.42';
