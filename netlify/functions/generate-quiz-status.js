...
const { bearerToken, configuredBearerMatches, handleCors, reply, unauthorized } = require('./lib/asyncHttp.js');
const {
...
exports.handler = async (event) => {
  ...
  if (!configuredBearerMatches(event) && !workerTokenMatches(job, bearerToken(event))) {
